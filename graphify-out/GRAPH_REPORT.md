...
10. `useAuthStore` - 22 edges

## Surprising Connections (you probably didn't know these)
- `latestCritique()` --calls--> `GET()`  [INFERRED]
  .agents/skills/impeccable/scripts/context-signals.mjs → apps/web/src/app/api/exchange-rate/route.ts
...
Cohesion: 0.10
Nodes (38): mergeDesignSystemFindings(), detectUrl(), runVisualContrastFallback(), serializeDesignSystemForBrowser(), CSS_IN_JS_EXTENSIONS, detectText(), extFromFilePath(), extractCSSinJS() (+30 more)
...
Cohesion: 0.08
Nodes (25): AdminPage(), AdminReceipt, AdminStats, AdminTab, AdminUser, CouponCode, LoginPage(), RegisterForm() (+17 more)
...
Cohesion: 0.15
Nodes (23): scrubManualEditsAgainstFile(), scrubManualEditsAgainstOriginalBlock(), clearAppliedEntries(), args, buffer, cwd, pageUrlFilter, remaining (+15 more)
...
Cohesion: 0.19
Nodes (23): isNeutralBorderColor(), checkColors(), checkElementAIPaletteDOM(), checkElementColors(), checkElementColorsDOM(), checkElementGlowDOM(), checkElementIconTile(), checkElementIconTileDOM() (+15 more)
...
Cohesion: 0.18
Nodes (14): authenticate(), AuthRequest, requireAdmin(), router, router, router, avatarDir, avatarStorage (+6 more)
...
Cohesion: 0.06
Nodes (31): Account card (per account), Active sessions, Add new account, API Endpoints Needed, Avatar, Build Order, Cancellation flow, Change password (+23 more)
...
Cohesion: 0.08
Nodes (24): API Endpoints Needed, Backend query (Express):, Build Order, Card 1 — Today's P&L, Card 2 — Today's Trades, Card 3 — Current Streak, Card 4 — Journal Status, Card design: (+16 more)
...
Cohesion: 0.10
Nodes (19): Color Palette (OKLCH), Concept, Landing Page Spec A — "The Trader's Terminal", Motion, Page Structure (8 sections), Responsive Strategy, Section 1 — Hero (100vh), Section 2 — Problem & Agitation (+11 more)

### Community 89 - "Community 89"
Cohesion: 0.10
Nodes (19): Color Palette, Concept, Conversion Optimization, Landing Page Spec C — "The Conversion Machine", Motion, Page Structure (6 sections, all dark), Persistent CTA Strategy, Responsive Strategy (+11 more)
...
Cohesion: 0.11
Nodes (18): Color Palette, Concept, Landing Page Spec B — "The Editorial Journal", Motion, Page Structure (7 sections, alternating light/dark), Responsive Strategy, Section 1 — Hero (Light), Section 2 — The Problem (Dark, full-width) (+10 more)
...
Cohesion: 0.17
Nodes (11): 1. Plan Overview & Feature Matrix, 2. Backend Middleware Protection, 3. ZarinPal Gateway Integration, 4. Frontend UI Implementation, Gateway Config (`/api/payments/checkout`), Layout Status Badges ([SideNavBar.tsx](file:///d:/Code/trade-journal/apps/web/src/components/layout/SideNavBar.tsx)), Local Mock Billing Gateway, TradeKav (تریدکاو) Subscription Plans & Access Control (+3 more)
...
Cohesion: 0.29
Nodes (7): getJalaliParts(), getMonthLength(), jalaliToGregorian(), JournalPage(), MONTH_NAMES, WEEKDAY_NAMES_SHORT, JournalEditorProps
...
Cohesion: 0.33
Nodes (6): ICON_MAP, Toaster(), NotificationState, Toast, ToastType, useNotificationStore
...
Cohesion: 0.22
Nodes (8): Build order for Spec A (enhanced), Final Ranking, Landing Page Comparison & Recommendation, My Recommendation: **Spec A — "The Trader's Terminal"**, Risk mitigation, Side-by-Side Comparison, What to steal from the other specs, Why Spec A wins
...
## Knowledge Gaps
- **1040 isolated node(s):** `COMMON_DEV_PORTS`, `SCANNABLE_EXT`, `SOURCE_DIRS`, `PRODUCT_NAMES`, `DESIGN_NAMES` (+1035 more)
...
- **Why does `confirm()` connect `Community 22` to `Community 56`, `Community 29`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `pickVariantContent()` connect `Community 50` to `Community 1`, `Community 44`, `Community 39`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.04383854584335739 - nodes in this community are weakly interconnected._