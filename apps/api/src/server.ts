...
import tradeMediaRouter from './routes/tradeMedia';
import tradeImportRouter from './routes/tradeImport';
...
app.use('/api/trades/emotions', emotionsRouter);
app.use('/api/trades', tradeImportRouter);
app.use('/api/trades', tradeMediaRouter);
