        ...
        const mapped: Trade[] = apiItems.map((item: any) => {
          ...
          return {
            ...
            annotation: item.annotation ? {
              htfBias: item.annotation.htf_bias ?? item.annotation.htfBias ?? null,
              session: item.annotation.session ?? null,
              marketCondition: item.annotation.market_condition ?? item.annotation.marketCondition ?? null,
              analysisTimeframe: item.annotation.analysis_timeframe ?? item.annotation.analysisTimeframe ?? null,
              entryTimeframe: item.annotation.entry_timeframe ?? item.annotation.entryTimeframe ?? null,
  ...
  updateTrade: async (updatedTrade: Trade): Promise<boolean> => {
    ...
    try {
      const res = await api.put(`/api/trades/${tradeId}`, {
        ...
        marketCondition: updatedTrade.annotation?.marketCondition,
        ...
        setupId: updatedTrade.setup?.concept.id || null,
